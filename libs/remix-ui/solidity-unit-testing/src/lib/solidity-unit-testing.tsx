        ...
        <div className="d-flex p-2">
          <CustomTooltip
            ...
            <button id="runTestsTabRunAction"data-id="testTabRunTestsTabRunAction" className="w-50 btn btn-primary" disabled={disableRunButton} onClick={runTests}>
              ...
              <label className="labelOnBtn p-1 ml-2 m-0"><FormattedMessage id='solidityUnitTesting.run' /></label>
            </button>
          </CustomTooltip>
          <CustomTooltip
            placement={'top'}
          ...
          >
            ...
            <span>
              ...
              <label className="labelOnBtn p-1 ml-2 m-0" id="runTestsTabStopActionLabel">{stopButtonLabel}</label>
            </span>
            </button>
          </CustomTooltip>
        </div>
